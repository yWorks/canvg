...
class Screen {
   ...
   * @internal
   */ /* eslint-enable jsdoc/check-tag-names */ async finishLoading() {
    ...
    async render(element) {
        let { ignoreDimensions = false, ignoreClear = false, scaleWidth, scaleHeight, offsetX, offsetY } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    /* eslint-disable jsdoc/check-tag-names */ /**
   * @internal
   */ /* eslint-enable jsdoc/check-tag-names */ renderFrame(element, ignoreDimensions, ignoreClear, scaleWidth, scaleHeight, offsetX, offsetY) {
...
class TextElement extends RenderedElement {
    ...
    getGlyph(font, text, i) {
        ...
        if (font.isArabic) {
            ...
            glyph = ((_font_arabicGlyphs_get = font.arabicGlyphs.get(char)) === null || _font_arabicGlyphs_get === void 0 ? void 0 : _font_arabicGlyphs_get.get(arabicForm)) || font.glyphs.get(char);
        } else {
...
class SVGElement extends RenderedElement {
    ...
    setContext(ctx) {
        ...
        if ('style' in canvas && typeof ctx.font !== 'undefined' && typeof (window === null || window === void 0 ? void 0 : window.getComputedStyle) !== 'undefined') {
...
class PatternElement extends Element {
    ...
    createPattern(ctx, _, parentOpacityProp) {
        ...
        patternSvg.attributes.set('width', new Property(this.document, 'width', `${width}px`));
        patternSvg.attributes.set('height', new Property(this.document, 'height', `${height}px`));
...
class GradientElement extends Element {
    ...
    createGradient(ctx, element, parentOpacityProp) {
        ...
        if (this.getAttribute('gradientTransform').hasValue()) {
            ...
            rect.attributes.set('x', new Property(document, 'x', -MAX_VIRTUAL_PIXELS / 3.0));
            rect.attributes.set('y', new Property(document, 'y', -MAX_VIRTUAL_PIXELS / 3.0));
...
class ImageElement extends RenderedElement {
    ...
    async loadSvg(href) {
        ...
        const subDocument = this.document.canvg.forkString(null, this.image);
...
class Document {
    ...
    constructor(canvg, { rootEmSize = DEFAULT_EM_SIZE, emSize = DEFAULT_EM_SIZE, createCanvas = Document.createCanvas, createImage = Document.createImage, anonymousCrossOrigin } = {}){
        ...
        this.screen.waitPromise(()=>this.loadImages());
        this.screen.waitPromise(()=>this.loadFonts());
    }
